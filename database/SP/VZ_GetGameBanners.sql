USE [DGSDATA]
GO
/****** Object:  StoredProcedure [dbo].[VZ_GetGameBanners]    Script Date: 11/7/2024 10:16:38 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	[VZ_GetGameBanners]
-- =============================================
CREATE PROCEDURE [dbo].[VZ_GetGameBanners]
	@IdGame int,
	@IdLanguage tinyint
AS
BEGIN
