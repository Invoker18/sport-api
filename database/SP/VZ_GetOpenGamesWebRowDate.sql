USE [DGSDATA]
GO
/****** Object:  StoredProcedure [dbo].[VZ_GetOpenGamesWebRowDate]    Script Date: 1/22/2025 16:08:22 ******/
SET ANSI_NULLS ON
GO
...
(
	...
	RowLangDescription    nvarchar(510),
...
INSERT INTO #tblMainGames
	...
	WR.IdWebRow
	,WR.[Description] AS RowDescription
	,LG.IDLeagueRegion
	,LG.LeagueOrder 
	,LG.ShortDescription
	,CASE WHEN LRL.[Description] IS NULL THEN LR.[Description] ELSE LRL.[Description] END AS RegionDescription
	,CASE WHEN WL.[Description] IS NULL THEN WR.[Description] ELSE WL.[Description] END AS RowLangDescription
