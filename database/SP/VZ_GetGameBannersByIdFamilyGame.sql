USE [DGSDATA]
GO
/****** Object:  StoredProcedure [dbo].[VZ_GetGameBannersByIdFamilyGame]    Script Date: 11/7/2024 10:16:38 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	[VZ_GetGameBannersByIdFamilyGame]
-- =============================================
CREATE PROCEDURE [dbo].[VZ_GetGameBannersByIdFamilyGame]
	@IdFamilyGame int,
	@IdLanguage tinyint
AS
BEGIN
	...
	WHERE G2.FamilyGame = @IdFamilyGame
	AND G.GameStat = 'B'
	AND G.Online = 1
